...
# 2. Setup CORS: Explicitly allow your Vercel frontend to talk to Render
# This resolves the "blocked by CORS policy" errors seen in the browser console
CORS(app, resources={r"/api/*": {"origins": "https://credlytic-minor-proj.vercel.app"}})
...
# ==========================================
# 4. FRONTEND HTML ROUTES (Fallback for local testing)
# ==========================================
